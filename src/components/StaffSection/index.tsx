...
export function StaffSection() {
  return (
    <section className="pb-10 md:pb-20 bg-blue-light-100">
      ...
      <ul className="grid grid-cols-[repeat(auto-fit,120px)] md:grid-cols-[repeat(4,120px)] lg:grid-cols-[repeat(5,120px)] justify-center gap-x-14 gap-y-14 md:gap-y-8 px-10">
