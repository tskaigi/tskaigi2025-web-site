...
社会の課題を解決し関係者全員の幸福を追求し続けることをミッションに、IT・医療・介護・若年層を中心とした人材事業や、Webメディア事業、M&Aコンサルティング事業など、社会貢献を軸に様々な領域でこれまで40以上のサービスを展開。2005年に創業以来、黒字経営を継続し19期目の2023年度は年商1149億を突破しました。各分野のスペシャリストが集うオールインハウスの組織構成と、業界を絞らないポートフォリオ経営で、時代を代表するグローバル企業を目指します。`,
    ...
    },
    {
      ...
      logoLink: "https://corp.kepple.co.jp/?utm_source=tskaigi2025&utm_medium=Paid+Other&utm_campaign=tskaigi_2025_sponsor&utm_id=tskaigi2025",
      addPadding: false,
      isTenantChecked: false,
      overview: [
...
エンジニアを積極的に採用していますので、開発組織の紹介ページをぜひご覧ください。`,
      ...
      links: [
        {
          title: "コーポレートサイト",
          href: "ttps://corp.kepple.co.jp/?utm_source=tskaigi2025&utm_medium=Paid+Other&utm_campaign=tskaigi_2025_sponsor&utm_id=tskaigi2025",
        },
        {
          title: "開発組織 紹介サイト",
