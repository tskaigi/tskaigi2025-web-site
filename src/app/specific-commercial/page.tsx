...
const specificCommercialData = {
  販売業者: "一般社団法人 TSKaigi Association",
  所在地: "東京都中央区東日本橋2-4-10 701",
  メールアドレス: "info@tskaigi.org",
  ...
  引渡時期:
    "TSKaigi 2025の開催期間は2025年5月23日から5月24日 です。お申し込み完了後、イベント当日に会場または指定の方法にてサービスを提供いたします。",
  "交換および返品（返金ポリシー）":
